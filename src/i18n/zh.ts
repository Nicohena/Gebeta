...
const zh: Translation = {
  ...
  hero: {
    tagline: "大胆风味，无界探索。",
    cta: "探索菜单",
    subtitle: "现代国际融合料理——为冒险的味蕾而生。",
  },
  filter: { all: "全部", smallPlates: "小食", mains: "主菜", burgers: "汉堡", desserts: "甜点", pasta: "意面" },
  drinks: {
    title: "精调饮品",
    subtitle: "手工调制，与每道菜完美搭配",
    craftCocktails: "精调鸡尾酒",
    coffee: "咖啡",
    nonAlcoholic: "无酒精",
    wine: "葡萄酒",
    beer: "啤酒",
  ...
  footer: {
    tagline: "大胆风味，无界探索。",
    hours: "营业时间",
    hoursValue: "周一至周四 上午11点–晚10点 · 周五至周六 上午11点–凌晨12点 · 周日 中午12点–晚9点",
    address: "融合大道123号，美食区",
